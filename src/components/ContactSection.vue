          ...
          <v-row justify="center">
            <v-col cols="12" sm="5">
              ...
              <h3 class="font-weight-light mt-3">
                Ponemos a su disposición nuestro correo electrónico, telefono y formulario de contacto para cualquier duda o cotización de nuestros servicios
              </h3>
              <h3 class="font-weight-light mt-3">
                En breve nos comunicaremos con usted.
              </h3>
              <h3 class="font-weight-light mt-3">
                Teléfono: +521 (22) 81234-5678
              </h3>
              <h3 class="font-weight-light">
                Email: ventas@cosvertech.com
              </h3>
            </v-col>
            <v-col cols="12" sm="7">
